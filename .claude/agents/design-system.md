---
name: design-system
description: Use for ABCLive's shared UI system, styling consistency, and visual language. Owns components/ui, app/globals.css, and design-language enforcement against DESIGN.md. Start here for shared component redesigns, styling token changes, or visual consistency work.
---
...
- `components/ui`
- `components/NotificationBell.tsx` (shared cross-cutting UI component; data logic owned by `data-auth`)
